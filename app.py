...
from api.Data_processing import data_processing  # 导入数据处理接口
...
from api.DataOB import get_averages
...
# 注册根据用户ID获取数据路由
app.route('/data/getByUserId', methods=['GET'])(getdataByuserid)
# 注册获取所有加密数据路由
...
# 注册获取所有用户的平均值路由
app.route('/data/averages', methods=['GET'])(get_averages)
# 启动Flask应用
